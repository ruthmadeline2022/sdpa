      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
            <form method="post" action="<?php echo base_url('index.php/detail/tambah');?>">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input style="background-color:white;color:black" type="text" class="form-control form-control-alternative" placeholder="SU Perkaderan dll" name="pelaksana" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">Sasaran</label>
                        <input style="background-color:white;color:black;display:block" type="text" class="form-control form-control-alternative" placeholder="Siswa, Guru, Alumni dll" name="sasaran" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input style="background-color:white;color:black;display:block" type="text" class="form-control form-control-alternative" placeholder="Aula, Masjid, dll" name="lokasi" required>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <td><input style="background-color:white;color:black" type="text" class="form-control form-control-alternative" placeholder="Terjalinnya ikatan muallimin dengan laumninya" name="capaian" required></td>
                                <td><input style="background-color:white;color:black" type="text" class="form-control form-control-alternative" placeholder="100%" name="target_capaian" required></td>
                            </tr>
                            <tr>
                                <th scope="row" rowspan="3">Masukan</th>
                                <td>Sumber Dana</td>
                                <td><input style="background-color:white;color:black" type="text" class="form-control form-control-alternative" placeholder="APBM" name="sumber_dana" required></td>
                            </tr>
                            <tr>
                                <td>Tenaga</td>
                                <td><input style="background-color:white;color:black" type="text" class="form-control form-control-alternative" placeholder="10 Orang" name="tenaga" required></td>
                            </tr>
                            <tr>
                                <td>Waktu</td>
                                <td><input style="background-color:white;color:black" type="text" class="form-control form-control-alternative" placeholder="1 hari" name="waktu" required></td>
                            </tr>
                            <tr>
                                <th scope="row">Keluaran</th>
                                <td><input style="background-color:white;color:black" type="text" class="form-control form-control-alternative" placeholder="Yang memadai" name="keluaran" required></td>
                                <td></td>
                            </tr>
                            </tbody>
                        </table>
