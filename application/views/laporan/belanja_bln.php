...
<body onload="window.print()">
    ...
    <div class="container-fluid mt--7">
      <div class="row mt-5">
        ...
        <p style="font-size:10pt;"><i>(Perbulan)</i></p>
        </center>
        <br/>
          <div class="card">
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" width="10%">Bulan Lalu</th>
                ...
                foreach ($kegiatan as $k) { 
                    ...
                    foreach ($pengeluaran as $pg) {
                        $pembelanjaan_lalu = $this->m_pembelanjaan->get_bln($pg['id_pengeluaran'],$lalu)->result_array();

                        

                        $pembelanjaan_sekarang = $this->m_pembelanjaan->get_bln($pg['id_pengeluaran'],$sekarang)->result_array();
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo "Rp " . number_format($k['tap_kegiatan'],2,',','.');?></td>
                    <td><?php echo "Rp " . number_format($jumlah_lalu,2,',','.');?></td>
                    <td><?php echo "Rp " . number_format($jumlah_sekarang,2,',','.');?></td>
                  </tr>
                </tbody>
                <?php } ?>
                <?php } ?>
